"""Phase 18A DEVELOPMENT-only end-to-end candidate proof."""
...
def _strategy_decisions(
    ...
    candidate = EmaRsiBtcContext.from_adapters(primary=primary, context=context)
...
@pytest.mark.e2e
def test_candidate_full_development_chain_filters_buy_only_and_preserves_holdout() -> None:
